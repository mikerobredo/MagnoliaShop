 ...
 */
public class PaymentGatewayVersionHandler extends DefaultModuleVersionHandler {

	private static String MODULE_NAME = IConstantsCommon.MODULE_NAME;
	private static String MODULE_DESCRIPTION = IConstantsCommon.MAGNOLIA_VERSION  + " - " + MODULE_NAME;
	
	public PaymentGatewayVersionHandler() {
		super();
