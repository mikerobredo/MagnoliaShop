 ...
 *
 */
public class PaymentPaypalSendDataDirectLink {
	...
	public PaymentPaypalSendDataDirectLink(String site) {
		super();
		
		this.sdkConfigIngenico = ConstantsIngenico.getMapSdkConfigSites().get(site);
		
		this.pspId = this.sdkConfigIngenico.getPSPID();
		this.userId = this.sdkConfigIngenico.getAPI_USERID();
		this.pswd = this.sdkConfigIngenico.getStringAPI_USER_PSWD();
		this.pm = "PAYPAL";
	}
