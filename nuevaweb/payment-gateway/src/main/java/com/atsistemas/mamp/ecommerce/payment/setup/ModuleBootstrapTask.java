package com.atsistemas.mamp.ecommerce.payment.setup;
...
public class ModuleBootstrapTask extends BootstrapResourcesTask {
    ...
    public ModuleBootstrapTask(String name, String description, int importUUIDBehavior) {
        ...
        MODULE_NAME = name;
        INSTALL_BOOTSTRAP_PATH = IConstantsCommon.INSTALL_BOOTSTRAP_ROOT_FOLDER + IConstantsSymbols.UNIX_PATH_SEPARATOR 
                + MODULE_NAME + IConstantsSymbols.UNIX_PATH_SEPARATOR + IConstantsCommon.INSTALL_BOOTSTRAP_FINAL_FOLDER;
    }
    ...
    protected boolean acceptResource(final InstallContext installContext, final String resourceName) {
        ...
        return resourceName.startsWith(IConstantsSymbols.UNIX_PATH_SEPARATOR + INSTALL_BOOTSTRAP_PATH) && resourceName.endsWith(IConstantsCommon.DOT_EXTENSION_BOOTSTRAP_FILE);
    }
